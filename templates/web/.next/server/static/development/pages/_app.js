...
var isBrowser = typeof window !== "undefined"; // Polyfill fetch() on the server (used by apollo-client)
...
function create(initialState) {
  ...
  return new apollo_boost__WEBPACK_IMPORTED_MODULE_0__["ApolloClient"]({
    ...
    link: new apollo_boost__WEBPACK_IMPORTED_MODULE_0__["HttpLink"]({
      uri:  false ? undefined : "http://localhost:4000/graphql",
      credentials: "include"
    }),
...
/* harmony import */ var _init_apollo__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./init-apollo */ "./lib/init-apollo.ts");
